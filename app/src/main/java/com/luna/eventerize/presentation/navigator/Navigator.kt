...
import com.luna.eventerize.presentation.ui.fragments.CreateEventFragmentNe
...
class Navigator(fragmentManager: FragmentManager) {
    ...
    fun displayEvents() {
        fragmentManager.beginTransaction().setCustomAnimations(R.animator.pop_fragment, R.animator.pop_out_fragment).replace(R.id.activity_auth_fragment, CreateEventFragmentNe.newInstance()).addToBackStack(null).commit()
    }
